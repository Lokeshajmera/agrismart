...
for(const [find_str, rep_str] of reps) {
    // Only replace strings exactly matching find_str that don't already have dark:
    // Basically just split on find_str + "'"
...
// Fix Circular Progress track
dash = dash.split("#e1efe6").join("currentUserTheme === 'dark' ? '#1f2937' : '#e1efe6'");
