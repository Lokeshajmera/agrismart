...
export default function AnalyticsReport() {
 ...
 // Temporarily comment out the farmer_id filter because the current // telemetry testing data has NULL farmer_ids in the database.
 // if (farmerId) {
 ...
 <span className="text-nature-400 dark:text-white">-</span>
 ...
 <tr key={idx} className="border-b border-nature-100 dark:border-nature-700/50 last:border-0 hover:bg-nature-50 dark:hover:bg-nature-800 dark:bg-nature-900/50">
