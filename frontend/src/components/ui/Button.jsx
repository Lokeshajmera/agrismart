...
export const Button = React.forwardRef(({ className, variant = 'default', size = 'default', children, ...props }, ref) => {
 ...
 "bg-white dark:bg-nature-950/80 backdrop-blur-sm border border-nature-200 dark:border-nature-800 text-nature-900 dark:text-white hover:bg-white dark:bg-nature-950 hover:shadow-md": variant === 'outline',
 "hover:bg-nature-100 dark:hover:bg-nature-700 dark:bg-nature-800/50 hover:text-nature-900 dark:text-white": variant === 'ghost',
