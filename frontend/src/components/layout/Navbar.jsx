...
export default function Navbar({ setIsMobileMenuOpen }) {
 ...
 return isMatch ? <strong key={i} className="text-earth-700 dark:text-earth-400 bg-earth-100 dark:bg-earth-900/40 px-0.5 rounded-sm">{part}</strong> : part;
 });
 };
 ...
 className="text-nature-600 dark:text-white hover:text-nature-900 dark:text-white transition-colors cursor-pointer p-1 shrink-0"
 >
 <Menu className="w-5 h-5 sm:w-6 sm:h-6" />
 </button>
 <div className="font-bold text-base sm:text-lg text-nature-800 dark:text-white flex items-center gap-1 sm:gap-2 tracking-tight shrink-0">
 ...
 <Search className="absolute left-3 top-2.5 h-4 w-4 text-nature-400 dark:text-white" />
 <input type="text"
 value={searchQuery}
 onChange={(e) => {
 ...
 'bg-nature-100 text-nature-500 dark:text-white dark:bg-nature-800'
 }`}>
 <Icon className="w-4 h-4" />
 </div>
 <div>
 <div className="text-sm font-medium text-nature-900 dark:text-white group-hover:text-earth-600 transition-colors line-clamp-1">
 {highlightText(suggestion.title, searchQuery)}
 </div>
 <div className="text-xs text-nature-400 dark:text-white font-medium">
 {suggestion.type}
 </div>
 </div>
 </button>
 ...
 <div className="px-4 py-3 text-sm text-nature-500 dark:text-white italic text-center">
 {t('Search Not Found')}
 </div>
 )}
 </div>
 ...
 <button onClick={() => setShowImpacts(!showImpacts)}
 ...
 <button
 onClick={toggleTheme}
 className="p-1.5 sm:p-2 text-nature-600 dark:text-white hover:bg-nature-50 dark:hover:bg-nature-800 dark:bg-nature-900 rounded-full transition-colors flex items-center gap-1 cursor-pointer shrink-0"
 ...
 className="p-1.5 sm:p-2 text-nature-600 dark:text-white hover:bg-nature-50 dark:hover:bg-nature-800 dark:bg-nature-900 rounded-full transition-colors flex items-center gap-1 cursor-pointer"
 >
 ...
 className={`w-full text-left px-4 py-2 text-sm hover:bg-nature-50 dark:hover:bg-nature-900 cursor-pointer ${i18n.language.startsWith(lang.code) ? 'text-earth-600 font-bold' : 'text-nature-700 dark:text-white '}`}
 >
 {lang.label}
 </button>
 ))}
 ...
 className="flex items-center gap-2 sm:gap-3 sm:pl-4 sm:border-l border-nature-200 dark:border-nature-800 hover:bg-nature-50 dark:hover:bg-nature-800 dark:bg-nature-900 rounded-xl py-1 sm:py-1.5 pl-1 pr-1 sm:pr-2 transition-colors cursor-pointer"
 >
 ...
 <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-nature-100 dark:bg-nature-800 overflow-hidden border border-nature-200 dark:border-nature-800 flex items-center justify-center text-nature-500 dark:text-white shrink-0">
 ...
 <p className="text-sm font-medium text-nature-900 dark:text-white">{profile.name}</p>
 <p className="text-xs text-nature-500 dark:text-white truncate">{profile.email}</p>
 </div>
 <div className="py-1">
 <Link to="/app/profile" className="flex items-center gap-2 px-4 py-2 text-sm text-nature-700 dark:text-white hover:bg-nature-50 dark:hover:bg-nature-800 dark:bg-nature-900 hover:text-earth-600">
 <User className="w-4 h-4" /> {t('Profile')}
 </Link>
 <Link to="/app/settings" className="flex items-center gap-2 px-4 py-2 text-sm text-nature-700 dark:text-white hover:bg-nature-50 dark:hover:bg-nature-800 dark:bg-nature-900 hover:text-earth-600">
 <Settings className="w-4 h-4" /> {t('Settings')}
 </Link>
 <Link to="/app/complaint" className="flex items-center gap-2 px-4 py-2 text-sm text-nature-700 dark:text-white hover:bg-nature-50 dark:hover:bg-nature-800 dark:bg-nature-900 hover:text-earth-600">
