            ...
            <div className={`max-w-4xl mx-auto ${isDashboard ? 'px-2' : 'px-4 py-16 sm:py-24'}`}>
                <div className="text-center mb-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
                    <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-4">
                        Get in <span className="text-transparent bg-clip-text bg-gradient-to-r from-earth-500 to-earth-700">Touch</span>
                    </h1>
                    <p className="text-nature-600 dark:text-nature-400 max-w-xl mx-auto text-lg leading-relaxed">
                        Have questions about our Smart Irrigation system? Our support team is here to help you optimize your farm.
                    </p>
                </div>
                ...
                <div className="bg-white dark:bg-nature-950 rounded-3xl p-8 md:p-12 shadow-xl shadow-nature-200/50 dark:shadow-none border border-nature-100 dark:border-nature-800 animate-in fade-in zoom-in-95 duration-500 delay-150 relative overflow-hidden">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
                        ...
                        <div className="flex flex-col items-center text-center p-6 rounded-2xl bg-nature-50 dark:bg-nature-900/50 border border-nature-100 dark:border-nature-800 hover:border-earth-300 dark:hover:border-earth-700 transition-colors group">
                            ...
                            <p className="text-nature-500 dark:text-nature-400 text-sm mb-4">For general inquiries and technical support.</p>
                        ...
                        <div className="flex flex-col items-center text-center p-6 rounded-2xl bg-nature-50 dark:bg-nature-900/50 border border-nature-100 dark:border-nature-800 hover:border-earth-300 dark:hover:border-earth-700 transition-colors group">
                            ...
                            <p className="text-nature-500 dark:text-nature-400 text-sm mb-4">Mon-Fri from 9am to 6pm IST.</p>
                        ...
                        <div className="flex flex-col items-center text-center p-6 rounded-2xl bg-nature-50 dark:bg-nature-900/50 border border-nature-100 dark:border-nature-800 hover:border-earth-300 dark:hover:border-earth-700 transition-colors group">
                            ...
                            <p className="text-nature-500 dark:text-nature-400 text-sm mb-4">Our headquarters and research facility.</p>
