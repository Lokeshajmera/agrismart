...
export default function Signup() {
 ...
 <h2 className="text-3xl font-extrabold text-nature-900 dark:text-white mb-4">{tLive("Check your email")}</h2>
 <p className="text-nature-600 dark:text-white">
 {tLive("We've sent a verification link to")} <strong>{email}</strong>{tLive(". Please click the link to verify your account.")}
 </p>
 <div className="mt-8">
 <Link to="/login" className="text-earth-600 font-medium hover:text-earth-500">
 {tLive("Return to login")}
 </Link>
 </div>
 </div>
 </div>
 ...
 <h2 className="text-center text-3xl font-extrabold text-nature-900 dark:text-white">{tLive("Create a new account")}</h2>
 </div>
 ...
 <div>
 <label className="block text-sm font-medium text-nature-700 dark:text-white ">{tLive("Email address")} <span className="text-red-500">*</span></label>
 ...
 <div>
 <label className="block text-sm font-medium text-nature-700 dark:text-white ">{tLive("Password")} <span className="text-red-500">*</span></label>
 <div className="mt-1 relative">
 ...
 <div>
 <label className="block text-sm font-medium text-nature-700 dark:text-white ">{tLive("Confirm Password")} <span className="text-red-500">*</span></label>
 <div className="mt-1 relative">
 <Lock className="absolute left-3 top-2.5 h-4 w-4 text-nature-400 dark:text-white" />
