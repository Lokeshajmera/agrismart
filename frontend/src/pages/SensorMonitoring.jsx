...
export default function SensorMonitoring() {
 ...
 <h4 className="text-sm font-bold text-nature-600 dark:text-white mt-1">{sensor.label}</h4>
 <p className="text-xs text-nature-400 dark:text-white mt-1">{sensor.desc}</p>
 </div>
 </div>
 ))}
 </div>
 ...
 <tr key={i} className="border-b border-nature-100 dark:border-nature-700/50 last:border-0 hover:bg-nature-50 dark:hover:bg-nature-800 dark:bg-nature-900/50 transition-colors">
 <td className="px-4 py-3 font-medium text-nature-900 dark:text-white">{row.id}</td>
 <td className="px-4 py-3 text-nature-600 dark:text-white">{row.type}</td>
