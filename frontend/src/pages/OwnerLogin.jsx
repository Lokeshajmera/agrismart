      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white dark:bg-nature-950 py-8 px-4 shadow-sm border border-nature-200 dark:border-nature-800 sm:rounded-xl sm:px-10">
          <form className="space-y-6" onSubmit={handleLogin}>
            <div>
              <label className="block text-sm font-medium text-nature-700 dark:text-nature-200">Director Email</label>
              <div className="mt-1 relative">
                ...
                <input 
                  ...
                  className="appearance-none block w-full pl-10 pr-3 py-2 border border-nature-300 dark:border-nature-700 dark:bg-nature-900 dark:text-white rounded-md shadow-sm placeholder-nature-400 focus:outline-none focus:ring-earth-500 sm:text-sm" 
