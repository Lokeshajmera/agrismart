        ...
        <div className="min-h-screen bg-nature-50 dark:bg-nature-900 font-sans text-nature-900 dark:text-white scroll-smooth">
            ...
            <section className="pt-32 pb-20 px-4 md:px-8 relative overflow-hidden">
                ...
                <div className="max-w-5xl mx-auto text-center relative z-10">
                    ...
                    <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-6 leading-tight">
                        AI-Driven Smart Irrigation System for <span className="text-transparent bg-clip-text bg-gradient-to-r from-earth-500 to-earth-700">Farms</span>
                    </h1>
                    <p className="text-lg md:text-xl text-nature-600 mb-10 max-w-2xl mx-auto leading-relaxed">
                        Maximize yield and minimize water waste using IoT sensors, satellite imagery, and advanced AI models trained for Indian climate conditions.
                    </p>
            ...
            <section className="py-20 px-4 md:px-8 max-w-6xl mx-auto">
                <div className="text-center mb-16">
                    ...
                    <p className="text-nature-600 max-w-2xl mx-auto">Everything you need to automate your irrigation system and monitor your farm's health from anywhere.</p>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {[
                        ...
                        { icon: Brain, title: 'AI Predictions', desc: 'Disease risk prediction and yield estimation models tailored for the Indian crop cycle.' },
            ...
            <footer className="bg-earth-900 border-t border-earth-800 pt-16 pb-8 text-earth-100/70">
                <div className="max-w-6xl mx-auto px-4 md:px-8 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center items-center gap-6 md:gap-12 mb-12 text-sm">
                        <div className="flex items-center gap-3"><div className="p-2 bg-earth-800 rounded-full"><Mail className="w-4 h-4 text-earth-400" /></div> support@agrismart.com</div>
                        <div className="flex items-center gap-3"><div className="p-2 bg-earth-800 rounded-full"><Phone className="w-4 h-4 text-earth-400" /></div> +91 XXXXX XXXXX</div>
                        <div className="flex items-center gap-3"><div className="p-2 bg-earth-800 rounded-full"><MapPin className="w-4 h-4 text-earth-400" /></div> India</div>
                    </div>
                    ...
                    <div className="border-t border-earth-800/50 pt-8 flex flex-col md:flex-row items-center justify-between text-sm">
                        ...
                        <div className="flex gap-4 mt-4 md:mt-0 items-center">
                            ...
                            <Link to="/legal" className="hover:text-white cursor-pointer transition-colors">Terms & Privacy</Link>
